...
const Login = () => {
  ...
  const loginForm = useFormik({
    ...
    onSubmit: (values) => {
      ...
      axios.post(
        `${process.env.NEXT_PUBLIC_API_BASE_URL || 'http://localhost:5001'}/user/authenticate`,
        values,
        {
          headers: {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center" style={{ background: '#000' }} suppressHydrationWarning>
      <div className="w-full max-w-md mx-auto my-8 bg-white border border-gray-200 rounded-xl shadow-2xs dark:bg-neutral-900 dark:border-neutral-700" style={{color:'#111'}} suppressHydrationWarning>
