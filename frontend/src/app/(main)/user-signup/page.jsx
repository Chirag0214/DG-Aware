...
const router = useRouter();
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center" style={{width: '100vw', background: '#000'}} suppressHydrationWarning>
      ...
      <div className="w-full max-w-md bg-white border border-gray-200 rounded-xl shadow-2xs dark:bg-white dark:border-neutral-700 p-6 sm:p-10 flex flex-col justify-center" style={{color:'#111', minHeight: 600}} suppressHydrationWarning>
