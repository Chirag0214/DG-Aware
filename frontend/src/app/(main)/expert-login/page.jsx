...
const expertLogin = () => {
  ...
  return (
    <div style={{ background: '#000', minHeight: '100vh' }} suppressHydrationWarning>
      <div className="h-screen bg-black py-20 p-4 md:p-20 lg:p-32" style={{color:'#111'}} suppressHydrationWarning>
